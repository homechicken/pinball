...
// parrot.bmp, TFT-Zim.bmp.bmp and TFT-logo.bmp.
...
void setup(void) {
  ...
  tft2.initR(INITR_GREENTAB); // Initialize screen
  ...
  stat = reader.drawBMP("/parrot.bmp", tft2, 0, 0);
  reader.printStatus(stat);   // How'd we do?
/*
  // Load small BMP 'TFT-logo.bmp' into a GFX canvas in RAM. This should fail
  ...
  Serial.print(F("Loading TFT-logo.bmp to canvas..."));
  stat = reader.loadBMP("/TFT-logo.bmp", img);
  reader.printStatus(stat); // How'd we do?
*/
